...
<div id="node-<?php print $node->nid; ?>" class="blog_wrap <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="title">
      ...
      <div class="post_meta">
          <span><i class="fa <?php print $node->field_type[$node->language][0]['value'];?>"></i></span>
  ...
  <div class="title clearfix">
    <h3 class="block-title"><span>Posted by <?php print strip_tags($name);?></span></h3>
  </div>
  <div class="authorbox_wrapper clearfix">
    <?php $uid = user_load($node->uid); ?>
    <div class="col-lg-4 col-md-4 col-sm-4 author-info">
      <?php print $user_picture; ?>
      <h4><?php print $name;?></h4>
      <span>active <?php print format_interval(REQUEST_TIME - $uid->created); ?></span>
    </div>
    <div class="col-lg-8 col-md-8 col-sm-8 author-desc">
      <p>
      <?php 
